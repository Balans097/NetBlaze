import std/[xmltree, strutils, unicode]


type
  HtmlTag* = enum  ## список всех поддерживаемых HTML-тегов; порядок всегда алфавитный
    tagUnknown,    ## неизвестный HTML-элемент
    tagA,          ## HTML-элемент `a`
    tagAbbr,       ## устаревший HTML-элемент `abbr`
    tagAcronym,    ## HTML-элемент `acronym`
    tagAddress,    ## HTML-элемент `address`
    tagApplet,     ## устаревший HTML-элемент `applet`
    tagArea,       ## HTML-элемент `area`
    tagArticle,    ## HTML-элемент `article`
    tagAside,      ## HTML-элемент `aside`
    tagAudio,      ## HTML-элемент `audio`
    tagB,          ## HTML-элемент `b`
    tagBase,       ## HTML-элемент `base`
    tagBasefont,   ## устаревший HTML-элемент `basefont`
    tagBdi,        ## HTML-элемент `bdi`
    tagBdo,        ## устаревший HTML-элемент `bdo`
    tagBig,        ## HTML-элемент `big`
    tagBlockquote, ## HTML-элемент `blockquote`
    tagBody,       ## HTML-элемент `body`
    tagBr,         ## HTML-элемент `br`
    tagButton,     ## HTML-элемент `button`
    tagCanvas,     ## HTML-элемент `canvas`
    tagCaption,    ## HTML-элемент `caption`
    tagCenter,     ## устаревший HTML-элемент `center`
    tagCite,       ## HTML-элемент `cite`
    tagCode,       ## HTML-элемент `code`
    tagCol,        ## HTML-элемент `col`
    tagColgroup,   ## HTML-элемент `colgroup`
    tagCommand,    ## HTML-элемент `command`
    tagData,       ## HTML-элемент `data` (добавлено для HTML5)
    tagDatalist,   ## HTML-элемент `datalist`
    tagDd,         ## HTML-элемент `dd`
    tagDel,        ## HTML-элемент `del`
    tagDetails,    ## HTML-элемент `details`
    tagDfn,        ## HTML-элемент `dfn`
    tagDialog,     ## HTML-элемент `dialog`
    tagDiv,        ## HTML-элемент `div`
    tagDir,        ## устаревший HTML-элемент `dir`
    tagDl,         ## HTML-элемент `dl`
    tagDt,         ## HTML-элемент `dt`
    tagEm,         ## HTML-элемент `em`
    tagEmbed,      ## HTML-элемент `embed`
    tagFieldset,   ## HTML-элемент `fieldset`
    tagFigcaption, ## HTML-элемент `figcaption`
    tagFigure,     ## HTML-элемент `figure`
    tagFont,       ## устаревший HTML-элемент `font`
    tagFooter,     ## HTML-элемент `footer`
    tagForm,       ## HTML-элемент `form`
    tagFrame,      ## HTML-элемент `frame`
    tagFrameset,   ## устаревший HTML-элемент `frameset`
    tagH1,         ## HTML-элемент `h1`
    tagH2,         ## HTML-элемент `h2`
    tagH3,         ## HTML-элемент `h3`
    tagH4,         ## HTML-элемент `h4`
    tagH5,         ## HTML-элемент `h5`
    tagH6,         ## HTML-элемент `h6`
    tagHead,       ## HTML-элемент `head`
    tagHeader,     ## HTML-элемент `header`
    tagHgroup,     ## HTML-элемент `hgroup`
    tagHtml,       ## HTML-элемент `html`
    tagHr,         ## HTML-элемент `hr`
    tagI,          ## HTML-элемент `i`
    tagIframe,     ## устаревший HTML-элемент `iframe`
    tagImg,        ## HTML-элемент `img`
    tagInput,      ## HTML-элемент `input`
    tagIns,        ## HTML-элемент `ins`
    tagIsindex,    ## устаревший HTML-элемент `isindex`
    tagKbd,        ## HTML-элемент `kbd`
    tagKeygen,     ## HTML-элемент `keygen`
    tagLabel,      ## HTML-элемент `label`
    tagLegend,     ## HTML-элемент `legend`
    tagLi,         ## HTML-элемент `li`
    tagLink,       ## HTML-элемент `link`
    tagMap,        ## HTML-элемент `map`
    tagMain,       ## HTML-элемент `main` (добавлено для HTML5)
    tagMark,       ## HTML-элемент `mark`
    tagMenu,       ## устаревший HTML-элемент `menu`
    tagMeta,       ## HTML-элемент `meta`
    tagMeter,      ## HTML-элемент `meter`
    tagNav,        ## HTML-элемент `nav`
    tagNobr,       ## устаревший HTML-элемент `nobr`
    tagNoframes,   ## устаревший HTML-элемент `noframes`
    tagNoscript,   ## HTML-элемент `noscript`
    tagObject,     ## HTML-элемент `object`
    tagOl,         ## HTML-элемент `ol`
    tagOptgroup,   ## HTML-элемент `optgroup`
    tagOption,     ## HTML-элемент `option`
    tagOutput,     ## HTML-элемент `output`
    tagP,          ## HTML-элемент `p`
    tagParam,      ## HTML-элемент `param`
    tagPicture,    ## HTML-элемент `picture` (добавлено для HTML5)
    tagPre,        ## HTML-элемент `pre`
    tagProgress,   ## HTML-элемент `progress`
    tagQ,          ## HTML-элемент `q`
    tagRp,         ## HTML-элемент `rp`
    tagRt,         ## HTML-элемент `rt`
    tagRuby,       ## HTML-элемент `ruby`
    tagS,          ## устаревший HTML-элемент `s`
    tagSamp,       ## HTML-элемент `samp`
    tagScript,     ## HTML-элемент `script`
    tagSection,    ## HTML-элемент `section`
    tagSelect,     ## HTML-элемент `select`
    tagSmall,      ## HTML-элемент `small`
    tagSlot,       ## HTML-элемент `slot` (добавлено для web components)
    tagSource,     ## HTML-элемент `source`
    tagSpan,       ## HTML-элемент `span`
    tagStrike,     ## устаревший HTML-элемент `strike`
    tagStrong,     ## HTML-элемент `strong`
    tagStyle,      ## HTML-элемент `style`
    tagSub,        ## HTML-элемент `sub`
    tagSummary,    ## HTML-элемент `summary`
    tagSup,        ## HTML-элемент `sup`
    tagTable,      ## HTML-элемент `table`
    tagTbody,      ## HTML-элемент `tbody`
    tagTd,         ## HTML-элемент `td`
    tagTemplate,   ## HTML-элемент `template` (добавлено для HTML5)
    tagTextarea,   ## HTML-элемент `textarea`
    tagTfoot,      ## HTML-элемент `tfoot`
    tagTh,         ## HTML-элемент `th`
    tagThead,      ## HTML-элемент `thead`
    tagTime,       ## HTML-элемент `time`
    tagTitle,      ## HTML-элемент `title`
    tagTr,         ## HTML-элемент `tr`
    tagTrack,      ## HTML-элемент `track`
    tagTt,         ## HTML-элемент `tt`
    tagU,          ## устаревший HTML-элемент `u`
    tagUl,         ## HTML-элемент `ul`
    tagVar,        ## HTML-элемент `var`
    tagVideo,      ## HTML-элемент `video`
    tagWbr         ## HTML-элемент `wbr`
...
const
  tagToStr* = [
    ...
    "details", "dfn", "dialog", "div", "dir", "dl", "dt", "em", "embed",
    "fieldset", "figcaption", "figure", "font", "footer", "form", "frame",
    "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header",
    "hgroup", "html", "hr", "i", "iframe", "img", "input", "ins",
    "isindex", "kbd", "keygen", "label", "legend", "li", "link", "map",
    "main", "mark", "menu", "meta", "meter", "nav", "nobr", "noframes",
    "noscript", "object", "ol", "optgroup", "option", "output", "p",
    "param", "picture", "pre", "progress", "q", "rp", "rt", "ruby",
    "s", "samp", "script", "section", "select", "small", "slot",
  ...
  InlineTags* = {tagA, tagAbbr, tagAcronym, tagApplet, tagB, tagBasefont,
    ...
    tagStrike, tagWbr, tagEmbed, tagPicture} ## Встроенные теги (обновлено для новых)
  BlockTags* = {tagAddress, tagBlockquote, tagCenter, tagDel, tagDir, tagDiv,
    ...
    tagMenu, tagNoframes, tagMain, tagTemplate, tagSlot} ## Блочные теги (обновлено для новых)
  SingleTags* = {tagArea, tagBase, tagBasefont,
    tagBr, tagCol, tagEmbed, tagFrame, tagHr, tagImg, tagInput, tagIsindex,
    tagLink, tagMeta, tagParam, tagWbr, tagSource, tagTrack} ## Одиночные теги (обновлено для HTML5 void elements)

proc `$`*(tag: HtmlTag): string = 
  ## Преобразует HtmlTag в строку.
  if tag == tagUnknown: "unknown"
  else: tagToStr[ord(tag) - 1]
...
proc entityToRune*(entity: string): Rune =
  ...
  if entity.len < 2: return # самая маленькая сущность имеет длину 2
  if entity[0] == '#':
    var runeValue = 0
    case entity[1]
    of '0'..'9':
    ...
    of 'x', 'X': # нечувствительно к регистру
      try: runeValue = parseHexInt(entity[2..^1])
      except ValueError: discard
    else: discard # другие сущности не определяются с префиксом `#`
    if runeValue notin 0..0x10FFFF: runeValue = 0 # возвращать только допустимые значения
    return Rune(runeValue)
  case entity # имена сущностей чувствительны к регистру
  of "Tab": Rune(0x00009)
  ...
  of "larr", "leftarrow", "LeftArrow", "slarr", "ShortLeftArrow": Rune(0x02190)
  of "uarr", "uparrow", "UpArrow", "ShortUpArrow": Rune(0x02191)
  of "rarr", "rightarrow", "RightArrow", "srarr", "ShortRightArrow": Rune(0x02192)
  of "darr", "downarrow", "DownArrow", "ShortDownArrow": Rune(0x02193)
  of "harr", "leftrightarrow", "LeftRightArrow": Rune(0x02194)
  of "varr", "updownarrow", "UpDownArrow": Rune(0x02195)
  of "nwarr", "nwarrow", "UpperLeftArrow": Rune(0x02196)
  of "nearr", "nearrow", "UpperRightArrow": Rune(0x02197)
  ...
  of "Larr": Rune(0x0219E)
  of "Uarr": Rune(0x0219F)
  of "Rarr": Rune(0x021A0)
  ...
  of "dharr", "downharpoonright", "RightDownVector": Rune(0x021C2)
  of "dharl", "downharpoonleft", "LeftDownVector": Rune(0x021C3)
  ...
  of "lrhar", "ReverseEquilibrium", "leftrightharpoons": Rune(0x021CB)
  ...
  of "rArr", "Rightarrow", "DoubleRightArrow": Rune(0x021D2)
  of "dArr", "Downarrow", "DoubleDownArrow": Rune(0x021D3)
  of "hArr", "Leftrightarrow", "DoubleLeftRightArrow": Rune(0x021D4)
  ...
  of "lBarr": Rune(0x021E4)
  of "rBarr": Rune(0x021E5)
  ...
  of "isin", "isinv": Rune(0x02208)
  of "notin", "NotElement": Rune(0x02209)
  of "niv", "ReverseElement", "ni", "SuchThat": Rune(0x0220B)
  of "notni", "notniva": Rune(0x0220C)
  of "prod": Rune(0x0220F)
  of "coprod": Rune(0x02210)
  of "sum": Rune(0x02211)
  of "minus": Rune(0x02212)
  of "mnplus", "mp", "MinusPlus": Rune(0x02213)
  of "plusdo", "dotplus": Rune(0x02214)
  of "setmn", "setminus", "Backslash", "ssetmn", "smallsetminus": Rune(0x02216)
  of "lowast": Rune(0x02217)
  of "compfn", "SmallCircle": Rune(0x02218)
  of "radic", "Sqrt": Rune(0x0221A)
  of "prop", "propto", "Proportional", "vprop": Rune(0x0221D)
  ...
  of "par", "parallel", "DoubleVerticalBar", "spar", "shortparallel": Rune(0x02225)
  of "npar", "nparallel", "nspar", "nshortparallel": Rune(0x02226)
  of "and": Rune(0x02227)
  of "or": Rune(0x02228)
  of "cap": Rune(0x02229)
  of "cup": Rune(0x0222A)
  ...
  of "asymp", "ap", "TildeTilde", "approx", "thkap", "thickapprox": Rune(0x02248)
  ...
  of "bump", "HumpDownHump": Rune(0x0224E)
  of "bumpe", "HumpEqual", "bumpeq": Rune(0x0224F)
  of "doteq", "DotEqual", "esdot": Rune(0x02250)
